...
const input='qa/source-export.glb',output='public/assets/SHANGRILA_MASTER_REFINED.glb';
...
await writeFile('qa/optimization-report.json',JSON.stringify(report,null,2));console.log(report);
